    ...
    <>
      ...
      <div>
            ...
            <div className="pl-6 pr-6 md:mr-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-16 xl:pl-32 ">
              ...
              <div className="py-8">
                <Link
                  ...
                  data-basketful-bundle-id="f8157266-4129-4646-942f-b431b15e90cc"
                >
                  Cart this Look
                </Link>
                <script
        ...
        <div className="bg-[#EEC7BD]/40">
          <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <div className="text-center leading-[2.5rem] lg:leading-[4rem] lg:pb-6 text-3xl lg:text-5xl font-bold text-[#4363F9]">
